...
//  lista_generica
//
//  Created by Wilfredo Aleman on 27/4/21.
//
...
int main()
{
    /**/
    Lista<int> miLista;
    cout << "La lista es: " << miLista.comoCadena() << endl
         << endl;
    ...
    cout << "Tamano de la lista: " << miLista.tamano() << endl
         << endl;

    cout << miLista.obtener(4) << endl
         << endl;

    cout << miLista.remover(2) << endl
         << endl;
    cout << "La lista es: " << miLista.comoCadena() << endl
         << endl;
    ...
    cout << "La lista es: " << miListaDouble.comoCadena() << endl
         << endl;

    Lista<double> miListaDouble2 = miListaDouble;
    cout << endl;

    cout << (miListaDouble.estaVacia() ? "true" : "false") << endl
         << endl;
    ...
    cout << "Tamano de la lista: " << miListaDouble.tamano() << endl
         << endl;

    cout << miListaDouble.obtener(4) << endl
         << endl;

    cout << miListaDouble.remover(2) << endl
         << endl;
    cout << "La lista es: " << miListaDouble.comoCadena() << endl
         << endl;
