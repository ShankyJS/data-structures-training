...
// Imprimir nombre y carnet del alumno
void imprimirSaludoAlumno();

int main()
{
    // Invocar la funcion que imprime el saludo del alumno cada vez que inicie el programa
    imprimirSaludoAlumno();
    int opcion;
    opcion = elegirOpcion();
    while (opcion != 3)
    {
